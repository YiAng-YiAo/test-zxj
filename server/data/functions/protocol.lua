...
Protocol = {
	...
	cFieldPlayerCmd_StartClientPk = 12,
	...
	sPlatformActivityCmd_CollectionRet = 5,
	sPlatformActivityCmd_WeiXinShareResult = 6,
	sPlatformActivityCmd_SendDayChargeGiftInfo = 7,
	sPlatformActivityCmd_SendQQVipPrivilegeGiftData = 8,
	sPlatformActivityCmd_SendQQVipGiftData = 9,

	cPlatformActivityCmd_GetGiftbag = 1,
	cPlatformActivityCmd_WeiXiGuanZhu = 2,
	cPlatformActivityCmd_WeiXinShare = 4,
	cPlatformActivityCmd_Collection = 5,
	cPlatformActivityCmd_DayChargeGiftOp = 6,
	cPlatformActivityCmd_GetQQVipPrivilegeGiftData = 7,
	cPlatformActivityCmd_GetQQVipPrivilegeGift = 8,
	cPlatformActivityCmd_GetQQVipGiftData = 9,
	cPlatformActivityCmd_GetQQVipGift = 10,
